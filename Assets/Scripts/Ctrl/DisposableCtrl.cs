...
public class DisposableCtrl
{
    public List<IDisposable> instances = new List<IDisposable>();
    public List<Action> disposeActions = new List<Action>();

    public bool isDisposing { get; private set; }

    public void Add<T>(T instance) where T : IDisposable
    {
    ...
    public void Remove<T>(T instance) where T : IDisposable
    {
