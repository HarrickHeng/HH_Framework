...
public class TransformHelper
{
    ...
    {
        get { return GameMgr.uiCamera; }
    }

		#region 世界坐标转屏幕坐标 WorldToScreenPoint
    ...
    public static Vector2 WorldToScreenPoint(Camera cam, Vector3 worldPoint)
    {
		...
		#region 屏幕坐标转世界坐标 ScreenPointToWorldPointInRectangle
    ...
    )
    {
		...
		#region 屏幕坐标转UGUI坐标 ScreenPointToLocalPointInRectangle
    /// <summary>
