...
public class SoundMgr
{
    ...
    {
        string eventNameGo = eventName.Replace('/', '_');
        StudioEventEmitter studioEvent = _root.FindChild<StudioEventEmitter>(eventNameGo);
        if (studioEvent)
        {
            studioEvent.Stop();
    ...
    public static void _playSoundDo(string eventName, GameObject voicer = null)
    {
        ...
        if (!voicer)
        {
            ...
            if (!studioEvent)
            {
                ...
                studioEvent = go.FindAddComponent<StudioEventEmitter>();
        ...
        {
            studioEvent = voicer.FindAddComponent<StudioEventEmitter>();
        ...
        studioEvent.EventReference.Path = eventName;
        studioEvent.Play();
    }
